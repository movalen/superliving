			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th style="width:210px;">Thumbnail</th>
						<th>Detail</th>
						<th class='text-center' style="width:165px;">
							<? echo anchor('admin/hilights/form', '<span class="glyphicon glyphicon-plus"></span> Add', 'class="btn btn-sm btn-info"'); ?>
						</th>
					</tr>
				</thead>
				<tbody>
					<?
						...
						?>
							<tr>
								...
								<td class='text-center'>
									<? 
										echo anchor('admin/hilights/form/'.$item->id, '<span class="glyphicon glyphicon-pencil"></span> Edit', 'class="btn btn-sm btn-warning"').' ';
										echo anchor('admin/hilights/delete/'.$item->id, '<span class="glyphicon glyphicon-remove"></span> Delete', 'class="btn btn-delete btn-sm btn-danger"');
									?>
								</td>
							</tr>
							<?
